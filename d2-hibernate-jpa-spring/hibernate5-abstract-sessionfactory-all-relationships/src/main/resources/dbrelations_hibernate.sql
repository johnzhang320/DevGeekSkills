...
CREATE TABLE `BOOK` (
  ...
  PRIMARY KEY (`BOOK_ID`),
  KEY `FKbj8bip3gmii2iwakx86il4939` (`AUTHOR_ID`),
  CONSTRAINT `FKbj8bip3gmii2iwakx86il4939` FOREIGN KEY (`AUTHOR_ID`) REFERENCES `AUTHOR` (`AUTHOR_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `PRODUCT121` VALUES (1,'Comfortable, fuel-saving car','Civic',20000);
...
INSERT INTO `PRODUCT_DETAIL` VALUES (1,'2,5m x 1,4m x 1,2m','Honda Automobile','Japan','ABCDEFGHIJKL',1000);
...
-- Dump completed on 2019-05-24 19:18:20
