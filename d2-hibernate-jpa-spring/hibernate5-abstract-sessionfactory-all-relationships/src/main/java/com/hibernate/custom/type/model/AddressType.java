...
public class AddressType implements CompositeUserType {
    ...
    public String[] getPropertyNames() {
        return new String[]{"addressLine1", "addressLine2","state",
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        empAdd.setCountry(rs.getString(names[4]));
        empAdd.setZipCode(rs.getInt(names[5]));
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session) throws HibernateException, SQLException {
        ...
        if (Objects.isNull(value))
            ...
            st.setString(index + 4, empAdd.getCountry());
            st.setInt(index + 5, empAdd.getZipCode());
        }
    }
