...
@PropertySource({ "classpath:hibernate-create.properties" })
@Component
public class SpringSessionFactoryCreate {
	
	static Logger Log = Logger.getLogger( SpringSessionFactoryCreate.class);
    @Autowired
    private Environment env;
   
  /*   
	@Bean
    public SessionFactory getSessionFactory(final LocalSessionFactoryBean sessionFactory ) {
	...
	*/
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setDataSource(dataSource());
        /**
         * package scan only instead of mapping all entity file as hibernate.cfg.xml does
         */
    ...
    /**
     * Define PlatformTransactionManager bean which activate the @Transactional
     * @return
     */
    @Bean
