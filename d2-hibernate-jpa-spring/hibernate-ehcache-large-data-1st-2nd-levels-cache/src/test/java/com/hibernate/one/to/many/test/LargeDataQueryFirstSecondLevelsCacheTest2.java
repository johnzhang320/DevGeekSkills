...
public class LargeDataQueryFirstSecondLevelsCacheTest2 extends BaseCacheTestDAO {
	static Logger Log = Logger.getLogger(LargeDataQueryFirstSecondLevelsCacheTest2.class);
	...
	public LargeDataQueryFirstSecondLevelsCacheTest2() {
