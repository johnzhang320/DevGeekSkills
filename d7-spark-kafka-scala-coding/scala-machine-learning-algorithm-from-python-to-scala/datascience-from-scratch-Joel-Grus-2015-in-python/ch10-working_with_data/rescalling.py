...
if __name__ == "__main__":
    ...
    print "a_to_b=",distance([1, 20, 2],[1, 30, 3])
    print "a_to_c=",distance([1, 20, 2],[1, 40, 4])
    print "rescalled a_to_b=",distance([1, -1.0, -1.0],[1, 0.0, 0.0])
    print "rescalled a_to_c=",distance([1, -1.0, -1.0],[1, 1.0, 1.0])
