...
public class FindDeepestBSTNode extends TestCase {
	class Node {
		char data;
		Node left;
		Node right;
	...
	/**
	 * Broad First Search , finally level Node must be deepest node 
	 * 
	 * @param root
	 * @return
	 */
