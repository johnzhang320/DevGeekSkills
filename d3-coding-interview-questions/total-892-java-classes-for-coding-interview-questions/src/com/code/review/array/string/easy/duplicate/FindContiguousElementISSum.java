...
public class FindContiguousElementISSum {
	...
	/**
	 *  Output the array to be summed to target
	 */
	public static int[] gotSubArray(int A[] , int target) {
	...
	public static void main(String[] args) {
		...
		System.out.println("x="+27+" sub array is "+Arrays.toString(gotSubArray(arr,27)));
	}
