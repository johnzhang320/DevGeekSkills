package com.code.review.array.string.middle.integer.to.money;

import java.util.HashMap;

public class IntegerToEnglishMoney {
	/**
	...
	public static void main(String[] args) {
		 ...
		 * 123 -> "One Hundred Twenty Three"
			12345 -> "Twelve Thousand Three Hundred Forty Five"
		 */
		IntegerToEnglishMoney ref = new IntegerToEnglishMoney();
		System.out.println(ref.numberToWords(342342480) );
		System.out.println(ref.numberToWords(659821) );
	}
