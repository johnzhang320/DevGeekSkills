package com.code.review.array.string.easy.miss.data;
...
public class FindMissPositive {
	 ...
	 *  (2) Skip negative number, add all elements in TreeSet<Integer> O(n)
	...
	public static void main(String[] args) {
		...
		System.out.println(firstMissingPositive(A6));
	}
