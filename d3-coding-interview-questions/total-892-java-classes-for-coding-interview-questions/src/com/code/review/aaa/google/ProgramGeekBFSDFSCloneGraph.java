...
public class ProgramGeekBFSDFSCloneGraph {
  ...
  // source is 1, then BFS 1->2->4->3->5	
	...
	public void dfs(Node source) {  //dfs has to use stack
		Stack<Node> stack = new Stack<Node>();
		stack.add(source);
		Map<Node,Boolean> visited = new HashMap<Node,Boolean>();
		visited.put(source, true);  // using map <Node,Boolean> node has name as identification is much better than using index
