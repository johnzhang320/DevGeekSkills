 ...
 *  result = digit+"->" + result
 *  (1) add each Lists to two stacks
 *  (2) cary = 0, while (!stack1.isEmpty() || !stack2.isEmpty())
 *  (3) cary=stack1.pop()+stack2.pop()+cary;
 *  (4) digit = cary %10; cary = cary /10;
 *  (5) result = digit+"->"+result (string)
 *  (6) if iteration finished, check if cary >0 result = cary + "->" +result
 *  (7)
 *    
 *  
 */
