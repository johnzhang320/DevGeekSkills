...
public class ContinuousArraySumIsMax {
     ...
     *. dp[n+1] , dp[0]
      ...
      * max = max(dp[i],max)
      * leetcode passed , using dp[0] = A[0] and dp[i] = Math.max(A[i], A[i]+dp[i-1] , could not passed leet code
     */
	...
	public static int getMaxSum2(int A[]) {
	  ...
	  public int longestPalindrome(String s) {
	        ...
	        return evenCount+oddCount+oddCount_1;
	    }
	public static void main(String[] args) {
		...
		System.out.println(ref.getMaxSum2(A4));
		System.out.println(ref.getMaxSum2(A5));
