...
public class SendingMessageTimeSum {
  ...
  Emp9(3)   Emp10(1)   Emp11(2)  EMP12(4)
	...
	public void dfsTimePath(Node root, int sum, List<String> list, String result[],int max[]) {
		if (root.belows==null) { // no child stop
			return;
		}
		// horizontal
		for (Node child : root.belows) {
			list.add(child.empName) ;
			dfsTimePath(child,sum+child.sendingTime,list,result,max);
	...
	public static void main(String[] args) {
		...
		f.dfsTimePath(root, root.sendingTime, list, result, max );
