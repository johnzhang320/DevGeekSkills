...
public class SolrJavaIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        solrJavaIntegration.addSolrDocument("123457", "John Zhang", "450463.56");
        solrJavaIntegration.addSolrDocument("123458", "Dennie Cha", "160021,55");
        solrJavaIntegration.addSolrDocument("123459", "Suresh Saiyer", "135299.99");
        solrJavaIntegration.addSolrDocument("123460", "Linna Dai", "95299.99");
    }
