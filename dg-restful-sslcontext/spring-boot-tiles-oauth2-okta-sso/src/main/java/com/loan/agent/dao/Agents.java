...
public class Agents implements java.io.Serializable {
	...
	public Agents(Integer agentId, Integer age, String firstName,
			String lastName, String emailAddress, String ipAddress,
			String ipAddressRange, String password, String companyName,
			String workPhone, String cellPhone, Blob pictureContent,
			String pictureFilename, String applicationFormFilename,
			String pictureType, String appFormType, String gendar,
			String address, String state, String zipCode, String description,
			String licenseNo, String dreNo, String nmlsNo,
			String licenseEligibleState, Timestamp modifiedDate, String city,
			String nicheIntro) {
		super();
