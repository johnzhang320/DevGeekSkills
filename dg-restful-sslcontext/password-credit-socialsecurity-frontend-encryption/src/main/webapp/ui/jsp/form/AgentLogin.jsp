...
<div class="module-title" >
	...
	<input type="button" value="Help" class="helpbutton" onclick="javascript:popUpFixedName('/password-credit-socialsecurity-frontend-encryption/helpAgentLogin.html','920','920');">            
</div>
