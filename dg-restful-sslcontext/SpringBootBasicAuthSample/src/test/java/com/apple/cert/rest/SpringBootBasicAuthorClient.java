...
import com.apple.cert.rest.model.User;


 
 
public class SpringBootBasicAuthorClient {
 
	 public static final String REST_SERVICE_URI = "http://localhost:8099/SpringBootRestApi/api";
    ...
    private static void listAllUsers(){
        ...
        ResponseEntity<User[]> response = restTemplate.exchange(REST_SERVICE_URI+"/user/", HttpMethod.GET, request, User[].class);
