...
public class EmailMarketingController extends SimpleFormController {
 static final Logger LOG = Logger.getLogger(EmailMarketingController.class);
	...
	public ModelAndView onSubmit(HttpServletRequest request,
        ...
        if (Constant.ACTION_SEND_EMAIL.equalsIgnoreCase(actionType)) {
    		...
    		if (Constant.ACTION_SEND_TO_EMAIL_LIST.equalsIgnoreCase(sendEmailTo)) {
    			   ...
    			   */
    			  form.setFromEmailAddress(agents.getEmailAddress());
