	...
	var baseUrl = "fetchCertPicCode.html";			     
	    $.ajax({
			...
			success: function(data, textStatus, jqXHR){
				...
				document.forms[0].realCertPicCode.value=data.currentCertPicCode;
				alert("Verify Code is "+data.currentCertPicCode);
			},
