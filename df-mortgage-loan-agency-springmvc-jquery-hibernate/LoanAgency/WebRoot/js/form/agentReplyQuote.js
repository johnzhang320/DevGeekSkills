    ...
    */
	...
	function uploadEmailContent() {
 			 ...
 			 document.forms['emailForm'].action="agentReplyQuote.html";
  ...
  function sendBatchEmail() {
 		...
 		var toEmailAddress = document.forms[0].toEmailAddress.value;
 		 ...
 		 */
 		   ...
 		   document.getElementById("sendEmailList").value="emailList";
 			...
 			if (isBlank(toEmailAddress)) { 				
 				errorFlag=true;
 				msg+="To Email Address is required!<br>";
 			} else {
 				if (!isValidEmail(toEmailAddress)) {
 					errorFlag=true;
 					msg+="To Email Address: "+ toEmailAddress+" is invalid!<br>";
 				}
 			}
