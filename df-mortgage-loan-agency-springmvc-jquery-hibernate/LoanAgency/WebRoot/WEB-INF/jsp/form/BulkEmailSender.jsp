...
<%
	...
	// if (null!=authUserName && null!=authPassword && null!=esConnectionStatus && "OK".equalsIgnoreCase(esConnectionStatus)) {
	 	   ...
	 	   legendStr="(1) Sign/Connect your Gmail. (2)  Upload Email List. ";
 ...
 <script type="text/javascript">				 
  ...
  <style type="text/css">
   ...
   <br><div class="module-title">  
   	      Bulk Email Sender for all Gmail Users 
    </div> 
	...
	<div id="configureMailServer">
	    ...
	    <fieldset >  
       	     ...
       	     <legend><span ><%=legendStr%></span></legend> 
       	    	 ...
       	    	 <input type="button" value="Connect Gmail" class="buttonImage"  onClick="javascript:popUpFixedName('/configureEmailServer.html','600','350');">
       	       	 <input type="button"  value="Upload Email List" class="buttonLeft" onclick="javascript:popUpFixedName('/uploadDocFile.html','900','650');">
	...
	<div id="editSendEmail" > 
      <form:form id="emailForm"  method="POST" name="emailForm" commandName="emailServerForm" enctype="multipart/form-data">
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/js/form/bulkEmailSender.js"> </script>  
