  <%
	   ...
	   String leftCapture =imagePath+ "mortgageLoanAgency_Yeary_Amortization.png";
...
<div class="module-title">
   Yearly Amortization Schedule Calculation  	                 
 </div>	 <div class="leftAreaSmall">
<fieldset>
 ...
 <input style="width:100px;" id="loan_amt" type="text" size="25" name="loan_amt"  value="417,000"/> 
  
 <br>
 <label id="int_rateLabel" style="width:90px" ><font color="red">*</font> Interest Rate: </label>
 <input style="width:100px;" id="int_rate" type="text" size="25" name="int_rate" value="3.125" />
 ...
 <select id="term" style="width:100px" name="term"  >
 <option value="360" selected="selected">30 years Fixed</option>
...
<input style="width:100px;" id="first_date" type="text" size="45" name="first_date" value="08-14-2012"/><br>
...
<input style="width:100px;" id="once_date" type="text" size="45" name="once_date" /><br><br><br>
	...
	<div style="padding-left:180px;">
       	...
       	<a  href="javascript:submitform('yearlyAmortOnline.html')"><img style="border:0px;padding-top:10px;padding-left:30px;" 
        		src="<%=request.getContextPath()%>/images/formImages/b_calculate.png" 
    			    		title="Show Amortization Web Report" width="86" height="30" />
      	</a>
      		<a  href="javascript:submitPdfform('yearlyAmortPDF.html')"><img style="border:0px;padding-top:10px;padding-left:30px;" 
        		src="<%=request.getContextPath()%>/images/formImages/b_pdfreport.png" 
    			    		title="Once PDF report is produced, Move Mouse to bottom of PDF page , you will find the Operation Bar , Click 'Save to Copy' icon to download your amortization PDF report !" width="86" height="30" />
      	</a>
      		<a  href="javascript:cancelform()"><img style="border:0px;padding-top:10px;padding-left:30px;" 
        		src="<%=request.getContextPath()%>/images/formImages/b_cancelAmort.png" 
    			    		title="Clean the current report and default input data" width="86" height="30" />
      	</a>
 	</div>   
