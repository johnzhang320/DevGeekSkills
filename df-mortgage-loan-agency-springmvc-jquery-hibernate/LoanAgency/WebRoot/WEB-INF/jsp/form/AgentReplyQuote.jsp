...
<%
	...
	if (loginAgentId!=null) {
	 	 request.getSession().setAttribute("emailServer","OK");	  
	       legendStr="(1) Pull Agent Profile Data. (2) Pull Borrower Quote. (3) Pull ApplicationCheckList";
 ...
 <br><div class="module-title">
         Agent :
       	 <logic:present name="loginAgentName" >  <bean:write name="loginAgentName" /> </logic:present>
      	 Reply Customer Quote
      	 <input type="button" value="Help" class="helpbutton" onclick="javascript:popUpFullScreen('/helpAgentReplyQuote.html','800','600');">
	...
	<div id="editSendEmail" > 
      <form:form id="emailForm"  method="POST" name="emailForm" commandName="emailServerForm" enctype="multipart/form-data">
              ...
              <form:hidden path="emailList" id="emailList"/>
	    	    ...
	    	    <fieldset >  
       			 	     <legend><span >(4) Edit Subject/Email Address. (5) Edit Email. (6) If need, Save/Upload Email and Attachments. (7) Send Email.</span> </legend>
		  			...
		  			<div id="toEmailAddress" style="display:block;" >
      				 <label  id="toEmailAddressLabel" style="font-weight:bold;"><font color="red">*</font>Receiver Email Address:</label>
                      	 <form:input path="toEmailAddress" id="toEmailAddress" size="80"  maxlength="250" /> 
   		      		    <label id="toEmailAddressMsg" class="errorMsg"></label>
		      		 <br> 
		      		 </div>		      	 	 	 
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/js/form/agentReplyQuote.js"> </script>  
