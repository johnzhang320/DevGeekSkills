<%@ page language="java" pageEncoding="ISO-8859-1"%>
 <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/menufiles/dropDownMenu.css" /><style type="text/css">._css3m{display:none}</style>
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
 ...
 <div class="mainmenu">
  ...
  <li class="topmenu"><a href="<%=contextPath%>affordableHomePrice.html" title="Calculators"><span>Loan Calculators</span></a>
	<ul>
	...
	<li class="topmenu"><a href="<%=contextPath%>downloadApplicationForm.html" title="Estimate Loan Amount, Loan Cmparision, Credit Check, Download Application Form"><span>PreConditions</span></a>
	...
	<li class="topmenu"><a href="<%=contextPath%>compareRefinanceLoans.html" title="Loan Comparison"><span>Loan Comparison</span></a>
	<ul>
    ...
    <li class="topmenu"><a href="<%=contextPath%>monthlyAmortization.html" title="Amortization Graphs"><span>Amortization Report / Graphs </span></a>
	<ul>
     ...
     <li class="topmenu"><a href="<%=contextPath%>education.html" title="Loan Process Guide"><span>Education</span></a>
	   <ul>
     ...
     <li  class="toplast"><a href="<%=contextPath%>userLogin.html" title="Send a Message to dennie"><span>Login</span></a>
		<ul>
