...
<script type="text/javascript">
	function findUsername() {
		...
		var form = document.getElementById("rolesForm");
 		form.action="/safebox/find_roles.html";
		form.submit();
...
<div class="container">
    ...
    <form:form  method="POST" id="rolesForm" name="rolesForm" modelAttribute="rolesForm" action="/safebox/assign_roles.html" cssClass="form-signin">
