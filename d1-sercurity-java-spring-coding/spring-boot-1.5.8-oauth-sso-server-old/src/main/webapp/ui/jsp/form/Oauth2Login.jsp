...
%> 
 ...
 <script type="text/javascript" src="<%=request.getContextPath()%>/ui/static/js/lib/jquery.jcryption-1.1.js"></script>
 <script type="text/javascript"	src="<%=request.getContextPath()%>/ui/static/js/utils/stringCryption.js"></script>
 <script type="text/javascript"	src="<%=request.getContextPath()%>/ui/static/js/form/agentLogin.js"></script>
...
<fieldset>
	...
	<br>
	<br>
	<img src="<%=request.getContextPath()%>/ui/static/images/PasswordSecureSSO.jpg" style="max-width:100%;max-height:100%"/>
</fieldset>
</form:form>

<!-- Front End Encryption -->
 
<script type="text/javascript"	src="<%=request.getContextPath()%>/ui/static/js/utils/stringCryption.js">		
</script>
  
<script type="text/javascript"	src="<%=request.getContextPath()%>/ui/static/js/form/agentLogin.js">		
</script>
