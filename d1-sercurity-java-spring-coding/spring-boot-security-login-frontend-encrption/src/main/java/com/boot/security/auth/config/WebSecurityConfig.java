...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
        .authorizeRequests()
        .antMatchers("/safebox/bankaccount.html").hasRole("SUPERUSER")    // need role ADMIN logins  //GET
        .antMatchers("/safebox/assign_roles.html").hasRole("ADMIN")    // need role ADMIN logins  //GET
        .antMatchers("/safebox/find_roles.html").hasRole("ADMIN")    // need role ADMIN logins  //GET
