...
import com.spring.rest.oauth.ssl.server.model4.Address;
import com.spring.rest.oauth.ssl.server.model4.Company;
import com.spring.rest.oauth.ssl.server.model4.Person;
...
public class PersonController {
	...
	@RequestMapping(value="/exchange/{id}", method = RequestMethod.GET ,produces = MediaType.APPLICATION_JSON_VALUE)
