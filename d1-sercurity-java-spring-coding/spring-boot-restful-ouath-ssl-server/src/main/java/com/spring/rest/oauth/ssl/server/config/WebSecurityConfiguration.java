...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
        .authorizeRequests()
        .antMatchers("/","/login","/getKeyPair.html","/oauth/authorize","/oauth/token","/secureServices","/data").permitAll()    // Spring boot 1.5.8 "/oauth/authorize","/oauth/token" are default but 2.0.0 are not default
