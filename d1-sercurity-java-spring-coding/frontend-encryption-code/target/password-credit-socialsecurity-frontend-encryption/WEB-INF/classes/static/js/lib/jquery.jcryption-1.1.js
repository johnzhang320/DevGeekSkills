...
*/
  ...
  *		success: success
  *	});
  *  which could return without server success data be sent back, therefore this code 
  *  can not be called in submit function.
  *  So we Chang $.getJSON to $.ajax which contain async :false and timeout,
  *   ensure this function doesn't return until really get public key 
  *  
        ...
        $.jCryption.getPublicKey = function(url,callback) {
            ...
            base.getKeys = function() {
               $.ajax({
    	 			...
    	 			dataType: "json",	 
    	 			url: url,		
    	 			async: false,    // hold on return until server response
    	 			timeout:800000,
            ...
            // Based RSA theory:  {e,n} is public key , {d,n} is private key, md=(p-1) x (q-1) , n=p x q, p 
