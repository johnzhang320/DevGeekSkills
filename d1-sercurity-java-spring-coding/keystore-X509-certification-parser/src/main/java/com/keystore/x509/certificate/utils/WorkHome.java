...
public class WorkHome {
	...
	public final static String CLASSES_HOME=getClassPath()+File.separator;
	...
	public final static String GIT_CRYPT_SYSTEM_HOME=WORK_HOME+"bin/";
	/**
...
//	public static String JKS_KEYSTORE_PATH=SSL_CLIENT_CERT_BUILD_DIR +"keystoreClient.jks";
    ...
    /**
     *  Found Java Classes Path
     */
    public static String getClassPath() {
    		WorkHome reference = new WorkHome();
    		return reference.getClass().getClassLoader().getResource("").getPath();
    }
