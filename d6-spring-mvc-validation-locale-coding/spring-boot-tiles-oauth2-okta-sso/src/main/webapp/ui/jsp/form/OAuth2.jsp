...
<script src="<%=contextPath%>/ui/static/js/oauth2/myOauth2App.js"></script>
	
<div class="module-title" >
	<spring:message code="title.oauth2.demo"/>  
	<input type="button" value="Help" class="helpbutton" onclick="javascript:popUpFixedName('/SpringbootSecurityDemo/helpAgentSingup.html','750','600');">            
</div>
