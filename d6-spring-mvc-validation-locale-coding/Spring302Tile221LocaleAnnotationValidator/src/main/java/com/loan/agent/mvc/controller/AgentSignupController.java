...
public class AgentSignupController  {
 static final Logger LOG = Logger.getLogger(AgentSignupController.class); 	 
	...
	@Autowired
	public AgentSignupController( AgentSignupValidator  agentSignupValidator){
		this.agentSignupValidator =  agentSignupValidator;
	}
	...
	public String processSubmit(
		...
		agentSignupValidator.validate(agentForm, result);
