...
public class AgentForm implements Serializable {
	...
	public static final Logger Log = Logger.getLogger(AgentForm.class);		
	/**
	 *  In SpringMVCValidation project we only use below fields
	 */
	private String agentFormAction;
	...
	public String getAgentFormAction() {
		return agentFormAction;
	}

	public void setAgentFormAction(String agentFormAction) {
		this.agentFormAction = agentFormAction;
	}
