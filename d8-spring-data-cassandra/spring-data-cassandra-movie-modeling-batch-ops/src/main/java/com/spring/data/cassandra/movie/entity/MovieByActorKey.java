package com.spring.data.cassandra.movie.entity;
...
public class MovieByActorKey implements Serializable {
  ...
  @PrimaryKeyColumn(name = "release_date", ordinal = 0, ordering = Ordering.DESCENDING)   // oridinal is order position in cluster key
